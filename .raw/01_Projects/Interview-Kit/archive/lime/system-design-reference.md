...
# System Design — Interview Reference Card
...
#### SaaS B2B Platform
*Help desk, CRM, project management, marketing automation — Lime fits here*
...
### Lime-Specific — Most Likely

|                                                                                                                                                                                                                         |                                                                                                                                                                                                                         |                                                                                                                                                                                                                         |                                                                                                                                                                                                                         |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <div style="background:rgba(239,68,68,0.12);padding:8px;border-radius:8px"><span style="font-size:1.3em">**MONOLITH → K8s**</span> <br> [[#Migration Checklist\|Strangler fig]] → route gradually · [[#Storage Picker\|Shared DB → DB-per-svc]] · [[#CI/CD Pipeline\|CI/CD day 1]] · [[#Observability\|OTel from start]] <br> *Why: Lime's #1 initiative. Start stateless, low-risk. Reverse proxy splits traffic. Every step reversible.*</div> | <div style="background:rgba(239,68,68,0.12);padding:8px;border-radius:8px"><span style="font-size:1.3em">**MULTI-TENANT SaaS**</span> <br> [[#Multi-Tenancy\|tenant_id column]] (start cheap) · [[#Resilience\|Rate limit per tenant]] · [[#Security Stack\|JWT tenant claim]] · GDPR residency <br> *Why: Lime's core model. Shared DB + tenant_id is simplest. Evolve to DB-per-tenant only for compliance.*</div> | <div style="background:rgba(239,68,68,0.12);padding:8px;border-radius:8px"><span style="font-size:1.3em">**MARKETING AUTOMATION**</span> <br> [[#Communication Picker\|Kafka]] triggers · [[#Storage Picker\|Redis]] for segment cache · [[#Scenario Templates\|Notification / Automation]] pipeline · A/B via feature flags <br> *Why: Lime product. Event-driven: user action → segment check → template render → multi-channel deliver.*</div> | <div style="background:rgba(239,68,68,0.12);padding:8px;border-radius:8px"><span style="font-size:1.3em">**OMNICHANNEL COMMS**</span> <br> [[#Communication Picker\|WebSocket]] for live chat · [[#Communication Picker\|Kafka]] for async channels · [[#Storage Picker\|MongoDB]] conversation store · Agent routing <br> *Why: Lime help desk. Unified inbox aggregates email+chat+phone. Route by skill, availability, tenant SLA.*</div> |
| <div style="background:rgba(239,68,68,0.12);padding:8px;border-radius:8px"><span style="font-size:1.3em">**AWS INFRA FROM SCRATCH**</span> <br> [[#IaC\|Terraform]] for EKS · [[#Kubernetes\|Kustomize]] for apps · [[#Security Stack\|Secrets Manager + IRSA]] · [[#AWS ↔ Azure\|Service map]] <br> *Why: They're building on AWS. K8s is K8s. Terraform is cloud-agnostic. Only service names differ.*</div> | <div style="background:rgba(239,68,68,0.12);padding:8px;border-radius:8px"><span style="font-size:1.3em">**HELP DESK / TICKET SYSTEM**</span> <br> State machine (open→assigned→resolved) · [[#Scaling\|CQRS]] for read-heavy dashboards · [[#Communication Picker\|Elasticsearch]] for search · SLA timer · Webhooks <br> *Why: Lime core product. CQRS because agents read 100x more than they write. ES for ticket full-text search.*</div> | <div style="background:rgba(239,68,68,0.12);padding:8px;border-radius:8px"><span style="font-size:1.3em">**CRM / SALES PIPELINE**</span> <br> [[#Storage Picker\|PostgreSQL]] for deals+contacts · [[#Communication Picker\|Kafka]] activity events · [[#Scenario Templates\|Search Platform]] · [[#Observability\|Analytics pipeline]] <br> *Why: Lime product. Relational data (deals, contacts, stages) needs ACID. Activity feed via events.*</div> | <div style="background:rgba(239,68,68,0.12);padding:8px;border-radius:8px"><span style="font-size:1.3em">**INTEGRATION / WEBHOOK PLATFORM**</span> <br> [[#Communication Picker\|Webhook]] receive+send · [[#Resilience\|Retry + DLQ]] · [[#Security Stack\|HMAC signature verification]] · Rate limiting <br> *Why: Lime connects to external systems. Inbound webhooks need verification. Outbound needs retry with backoff.*</div> |
...
*[[company-lime|Back to Lime Prep]]*
